...
![Choose your plan](https://github.com/zengzengzenghuy/AWS-diary/blob/main/Image/Create-an-AWS-Account/Choose_your_plan.png)
7. Click complete sign up and you've now had an AWS account!
![Sign up successful](https://github.com/zengzengzenghuy/AWS-diary/blob/main/Image/Create-an-AWS-Account/Sign_up_successful.png)
...
![Sign in](https://github.com/zengzengzenghuy/AWS-diary/blob/main/Image/Create-an-AWS-Account/Sign_in.png)
10. Click **Next** and insert your password.
11. You will enter the AWS Management Console page.
![AWS management console](https://github.com/zengzengzenghuy/AWS-diary/blob/main/Image/Create-an-AWS-Account/AWS_management_console.png)
